...
const cases = [
...

  {
    ...
    sections: [
      ...
      },
      {
        eyebrow: "What it actually cost",
        heading: "The real costs",
        description: "A food commons became a shuffleboard bar. The community is now asked to ratify the land sale eight years after the appraisal.",
        items: [
          ...
          { label: "$953K sale at 2018 appraisal", desc: "If the August 2026 ballot passes, publicly owned riverfront land transfers to private ownership at a price set eight years before the vote, with no independent reappraisal." },
          { label: "$2,000/month lease revenue foregone", desc: "The parks department loses $24,000/year in perpetuity in exchange for a one-time $953K payment." },
          { label: "Rotary Park beach unusable", desc: "The park built around the river cannot be used for swimming due to E. coli. The amenity exists; the actual use is foreclosed by pollution — the same Red Cedar contamination documented in the Frandor case." },
        ],
      },
      {
        eyebrow: "The accounting gap",
        heading: "The purchase option was in the 2021 lease",
        description: "The Lansing Shuffle is a functioning business that activates the riverfront. That is a genuine benefit. But it was achieved by converting a public food commons into a private entertainment venue, and the purchase option written into the 2021 lease means the conversion to private ownership was the plan from the beginning — not an outcome the public was asked to weigh in on until 2026. The community received a bar where it had a market, and is now being asked to ratify the sale of the land beneath it.",
        items: [
    ...
    principles: [
      { num: 3, name: "Member Economic Participation", violation: "Community did not participate in the economic decision to convert a public food commons to private ownership", evidence: "Purchase option written into 2021 lease without public process; 2026 ballot ratifies a decision made in 2021." },
      { num: 7, name: "Concern for Community", violation: "Food access commons lost; sale price set 8 years before vote", evidence: "$953K 2018 appraisal; no independent reappraisal; $24K/year lease revenue foregone in perpetuity." },
    ],
    ownership: [
      { question: "Who owns it?", before: "City of Lansing (WPA-built public market, 1938)", after: "Lansing Shuffle LLC (private) — if August 2026 ballot passes", assessment: "extractive" },
      { question: "Who has power?", before: "City parks department + city council", after: "Private owner; city council approved 6-1 to put sale on ballot", assessment: "extractive" },
      { question: "Who benefits?", before: "All Lansing residents (food commons, public riverfront)", after: "Shuffle LLC (land ownership); downtown visitors (riverfront activation); city (one-time $953K)", assessment: "mixed" },
      ...
      { question: "Who makes the rules?", before: "City council + parks department", after: "Private owner (if sale passes); city retains no use restrictions on the land", assessment: "extractive" },
    ],
    bottomLines: [
      { dimension: "People", impact: "negative", description: "81 years of public food access replaced by a private shuffleboard bar. The community with the least access to private entertainment — and the most need for public food infrastructure — loses the most." },
      { dimension: "Planet", impact: "ok", description: "WPA-era building preserved. No significant environmental impact from ownership change itself (vs. Red Cedar contamination that makes the adjacent park unusable regardless)." },
      { dimension: "Prosperity", impact: "negative", description: "$953K one-time vs. $24K/year perpetual lease income foregone. No independent reappraisal since 2018. Community swaps ongoing revenue for a one-time payment on an 8-year-old valuation." },
      { dimension: "Purpose", impact: "negative", description: "Public food commons → private entertainment venue. The conversion to private ownership was embedded in the 2021 lease; the 2026 ballot is ratification, not decision-making." },
    ],
    recommendations: [
      "Advocate for a city council policy requiring independent reappraisal and a mandatory 90-day public comment period before any publicly owned land sale goes to a ballot question.",
      "Require any future public building lease to prohibit purchase options without separate council approval and public comment.",
      "Build the case for community land trust as the default vehicle for public asset disposition — maintains public ownership of land while allowing private investment in the building.",
    ],
    sources: [
...

  {
    ...
    date: "ongoing",
    published: true,
    summary: "The Lansing Regional Chamber PAC exists to elect officials aligned with Chamber member priorities. Six of eight sitting Lansing City Council members have accepted LRC-PAC money. This is the mechanism that shapes the outcome of every other case in this accounting — until it is broken or counterbalanced, every other item will keep recurring in new forms.",
    stats: [
      ...
      { value: "6-1", label: "Council vote to put Shuffle sale on ballot" },
    ...
    sections: [
      ...
      },
      {
        ...
        description: "This case has no benefit/cost columns in the usual sense, because its function is to determine the benefit/cost split in every other case. It is the reason the Shuffle sale passed 6-1, the reason the LHC board has the composition it has, and the reason a binding neighborhood council or independent reappraisal requirement has not yet been enacted despite being a simple council-majority action. Until this loop is broken or counterbalanced, every other item in this accounting will keep recurring in new forms.",
        items: [
          { label: "Only two non-PAC-funded council members", desc: "Ryan Kost and Adam Hussain have not accepted LRC-PAC money. They are the existing council allies for the reform agenda. Building from two to five requires the electoral work described in the plan forward." },
        ],
      },
    ],
    principles: [
